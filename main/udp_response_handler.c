...
void udp_get_info_response(int sock , int ip4 , int account_index , char *rx_buffer){
	...
	send_data_len = sprintf(send_data , "%s,%s,%s,%s,%s,%s,%s" , device_wifi_info , DEVICE_UNIQUE_ID_STR , DEVICE_NAME , DEVICE_TYPE, AWS_TOPIC_MINOR_ID , FIRMWARE_VERSION , HARDWARE_VERSION);
