...
#define MQTT_COMMAND_TOPIC                  AWS_NETWORK_NAME "/" DEVICE_TYPE "/" AWS_TOPIC_MAJOR_ID AWS_TOPIC_MINOR_ID "/command"  
#define MQTT_COMMAND_TOPIC_LENGTH           ( ( uint16_t ) ( sizeof( MQTT_COMMAND_TOPIC ) - 1 ) )

#define MQTT_RESPONSE_TOPIC                  AWS_NETWORK_NAME "/" DEVICE_TYPE "/" AWS_TOPIC_MAJOR_ID AWS_TOPIC_MINOR_ID "/response"  
#define MQTT_RESPONSE_TOPIC_LENGTH           ( ( uint16_t ) ( sizeof( MQTT_RESPONSE_TOPIC ) - 1 ) )

#define MAX_OUTGOING_PUBLISHES              ( 50U )
